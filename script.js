...
const foods = [
  ...
  { id:16, name:'Risalamande', price: 12, category:'bode4', img:'./images/Risalamande.png', desc:'Klassisk dansk juledessert med mandler og kirsebærsovs.', recipe:["Kog risene møre i mælk med vanilje og salt","Lad risengrøden køle helt af","Hak mandler fint","Pisk fløde til skum","Bland den kolde risengrød med hakkede mandler","Vend den piskede fløde forsigtigt i","Læg hele mandlen i til den der finder den","Server med varm kirsebærsovs"] },
  { id:17, name:'Kartoffel Porrersuppe', price: 15, category:'bode5', img:'./images/Kartoffel Porrersuppe.png', desc:'Cremet og varmende suppe med kartofler og porre.', recipe:["Skær kartofler i tern og porre i skiver","Svits porrerne i smør til de er bløde","Tilsæt kartofler og bouillon","Kog til kartofler er møre","Blend suppen til ønsket konsistens","Tilsæt fløde og varm igennem","Smag til med salt og peber","Server med brød"] },
];
