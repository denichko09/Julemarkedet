...
const foods = [
  ...
  { id:11, name:'Kakao', price: 5, category:'bode3', img:'./images/Kakao.png', desc:'Varm, cremet kakao med flødeskum og marshmallows.', recipe:["Varm mælk i gryde til det er varmt men ikke koger","Tilsæt kakaopulver og sukker","Pisk godt sammen til det er glat","Hæld op i krus","Top med flødeskum og marshmallows","Drys med lidt ekstra kakao på toppen"] },
